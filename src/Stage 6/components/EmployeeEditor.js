...
class EmployeeEditor extends Component {
  ...
  // save
  save(){
    this.originalEmployee.updateName(this.state.employee.name);
    this.originalEmployee.updatePhone(this.state.employee.phone);
    this.originalEmployee.updateTitle(this.state.employee.title);
    this.setState({
      notModified: true
    })
